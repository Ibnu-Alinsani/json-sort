...
<template>
  ...
  <section class="editor-section">
    <div>
      ...
      <select id="sort" name="sort" v-model="sortDirection">
        <option v-for="direction in SortDirection" :value="direction">
          {{ direction }}
        </option>
      </select>
      <button id="btn-sort" @click="on.btnSortDirection.click">sort</button>
    </div>

    <!-- Editor component -->
    <Editor v-model="code" width="50rem" height="30rem" />
  </section>
</template>
